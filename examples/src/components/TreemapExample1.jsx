...
export class TreemapExample1 extends Component {
    constructor(props){
        super(props);
    ...
    onLoadingChanged(...params) {
        // eslint-disable-next-line no-console
        return console.log("TreemapExample1 onLoadingChanged", ...params);
    }
    onApply(filter) {
        // eslint-disable-next-line no-console
        console.log("TreemapExample1 onApply", filter);
    ...
    onError(...params) {
        // eslint-disable-next-line no-console
        return console.log("TreemapExample1 onError", ...params);
    }
    ...
    render() {
        ...
        const measures = Model.measure(avgCheckSizeIdentifier).format("#,##0");
...
export default TreemapExample1;
