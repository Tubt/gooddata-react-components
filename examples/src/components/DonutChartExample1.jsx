...
import { DonutChart, Model, AttributeFilter, ErrorComponent, HeaderPredicateFactory } from "@gooddata/react-components";
...
const drillableItems = [
    HeaderPredicateFactory.identifierMatch(locationResortIdentifier),
];

export class DonutChartExample1 extends Component {
    constructor(props){
        super(props);
    ...
    onLoadingChanged(...params) {
        // eslint-disable-next-line no-console
        return console.log("DonutChartExample1 onLoadingChanged", ...params);
    }
    onApply(filter) {
        // eslint-disable-next-line no-console
        console.log("DonutChartExample1 onApply", filter);
    ...
    onError(...params) {
        // eslint-disable-next-line no-console
        return console.log("DonutChartExample1 onError", ...params);
    }
            ...
            <div className="s-attribute-filter">                
                ...
                <div style={{ height: 700 }} >   
                    ...
                    <ExampleWithExport >  
                        ...
                        {onExportReady => (
                            <div style={{ height: 600 }} className="s-donut-chart">
                                {error ? (
...
export default DonutChartExample1;
